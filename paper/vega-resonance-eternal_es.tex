...
\title{VEGA RESONANCE ETERNAL: Un Marco Conceptual}
...
\begin{abstract}
Este trabajo introduce VEGA RESONANCE ETERNAL como un nuevo marco conceptual dentro del paradigma Resonance Data y QIRC.
\end{abstract}
